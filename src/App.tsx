    ...
    <div className="h-dvh w-screen bg-[#0f1115] text-gray-200 flex flex-col font-sans text-sm overflow-hidden bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-gray-800 via-gray-900 to-black">
      ...
      <footer className="flex-shrink-0 bg-gray-900/95 backdrop-blur-lg flex justify-around items-center border-t border-gray-800 h-16 pb-safe safe-area-pb z-50">
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center w-16 h-full transition-all duration-300 ${view === 'chat' ? 'text-purple-400' : 'text-gray-600 hover:text-gray-400'}`}
        >
          <SparklesIcon className={`w-5 h-5 mb-1 ${view === 'chat' ? 'fill-current drop-shadow-[0_0_5px_rgba(168,85,247,0.5)]' : ''}`} />
